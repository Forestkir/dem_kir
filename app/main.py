...
COLOR_MAIN = "#FFFFFF"  # основной
COLOR_SECOND = "#DAA520"  # доп
COLOR_ACCENT = "#B8860B"  # акцент
COLOR_DISCOUNT = "#F4A460"  # скидка > 12%
COLOR_ZERO_STOCK = "#ADD8E6"  # голубой, когда нет на складе

# для pyinstaller пути
def get_base_dir():
    # если программа запущена как скомпилированный .exe файл
    if getattr(sys, 'frozen', False):
        return sys._MEIPASS
    # если запущена из исходника в PyCharm (из папки app)
    else:
...
class ProductFormDialog(QDialog):
    ...
    def save_data(self):
        ...
        if self.selected_photo_path:
            ...
            # автоматическое форматирование 300 на 200 загружаемой фотки
